...
from models.psp.feature_resnet import *

from models.psp.helpers import (
    get_blocks,
    Flatten,
    bottleneck_IR,
    bottleneck_IR_SE,
...
class Inverter(nn.Module):
    def __init__(self, opts, n_styles=18):
        super(Inverter, self).__init__()

        self.fs_backbone = FSLikeBackbone(opts, n_styles=n_styles)
...
class FSLikeBackbone(nn.Module):
    def __init__(self, opts, n_styles=18):
        ...
        resnet50 = iresnet50()
        resnet50.load_state_dict(torch.load(opts.arcface_path))
