...
from criteria.pl_loss.lbs import lbs, batch_rodrigues, vertices2landmarks, rot_mat_to_euler
...
class FLAME(nn.Module):
    ...
    def __init__(self, config, path):
        ...
        shapedirs = torch.cat([shapedirs[:, :, :config.model.n_shape], shapedirs[:, :, 300:300 + config.model.n_exp]], 2)
